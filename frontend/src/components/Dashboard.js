    ...
    return(
        <div className='dashboard'>
            ...
            <div class="container">
                ...
                <>
                                ...
                                <div className='container id-card'>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-8">
                                            ...
                                            <button onClick={showEditForm} type="button" class="btn btn-secondary" style={{bottom: "45px", position: "absolute", right: "10px"}}>Edit Profile </button>
                                            <button onClick={makePost} type="button" class="btn btn-secondary" style={{bottom: "0px", position: "absolute", right: "10px"}}> Make a post </button>
                                        </div>    
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row dash-row-2" style={{marginTop: "100px", backgroundColor: 'white'}} >
                        ...
                        <div class="col">
                            ...
                            <br/>
                            {!loading ? user.skills.map(skill => <div className='custom-card' > <h6 className='custom-card-text'>{skill.name}</h6> </div>) : null}
                    ...
                    <div class="row dash-row-3" style={{marginTop:"100px", height: "auto", marginBottom: "100px"}}>
                        ...
                        <div class="col">
                            ...
                            {!loading ? user.projects.map(project => <div className='custom-card'> <h6 className='custom-card-text'>{project.name}</h6> </div>) : null}
                            <br/>
                ...
                :
                <BlogPost user={user} makePost={makePost} />
                }
